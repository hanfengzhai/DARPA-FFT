...
with open('data_id24_lat.txt', 'r') as f1:
...
with open('data_id24_lon.txt', 'r') as f2:
...
x_benchmark = np.linspace(0, 14, 14)# 550
xpred = np.linspace(14, 359, 345)#440 - 550
y_lat = x1[0:14]
y_long = x2[0:14]
...
np.savetxt(('idnew24'+'.txt'),final_pred)
