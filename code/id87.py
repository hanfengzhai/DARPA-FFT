...
with open('data_id87_lat.txt', 'r') as f1:
...
with open('data_id87_lon.txt', 'r') as f2:
...
x = np.linspace(0, 261, 261)
x_benchmark = np.linspace(0, 261, 261)# 550
xpred = np.linspace(261, 606, 345)#440 - 550
y_lat = x1[0:261]
y_long = x2[0:261]
...
np.savetxt(('idnew87'+'.txt'),final_pred)
