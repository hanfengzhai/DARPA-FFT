...
with open('data_id1_lat.txt', 'r') as f1:
...
with open('data_id1_lon.txt', 'r') as f2:
...
x = np.linspace(0, 9, 9)
x_benchmark = np.linspace(0, 9, 9)# 550
xpred = np.linspace(9, 354, 345)#440 - 550
y_lat = x1[0:9]
y_long = x2[0:9]
...
np.savetxt(('idnew1'+'.txt'),final_pred)
