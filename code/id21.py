...
with open('data_id21_lat.txt', 'r') as f1:
...
with open('data_id21_lon.txt', 'r') as f2:
...
x_benchmark = np.linspace(0, 364, 364)# 550
xpred = np.linspace(364, 709, 345)#440 - 550
y_lat = x1[0:364]
y_long = x2[0:364]
...
dat_24_lat = y_pred_lat[135:161]
dat_26_lat = y_pred_lat[184:207]
dat_28_lat = y_pred_lat[230:253]
dat_30_lat = y_pred_lat[276:299]
dat_2_lat = y_pred_lat[322:345]

dat_24_long = y_pred_long[135:161]
dat_26_long = y_pred_long[184:207]
dat_28_long = y_pred_long[230:253]
dat_30_long = y_pred_long[276:299]
dat_2_long = y_pred_long[322:345]
...
np.savetxt(('idnew21'+'.txt'),final_pred)
